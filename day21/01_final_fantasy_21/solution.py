""" Solution to the first puzzle of Day 21 on adventofcode.com
"""
        ...
        for armor in armors:
            for ring1 in rings:
                for ring2 in rings:
                    ...
                    if b_hp <= 0 and price <= best_price:
                        best_loadout = [weapon, armor, ring1, ring2]
                        best_price = price
                        print best_price, best_loadout
